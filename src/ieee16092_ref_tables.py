...
ieee16092_spdu_ref = [  # col[0]=field, col[1]=parent, col[2]=length, col[3]=eval method, col[4]=val1, col[5]=val2, col[6]=mandatory
    ...
    ["ieee1609dot2.content", "ieee1609dot2.Ieee1609Dot2Data_element", 1, 0, 0, 128, False], # range unverified
    ...
    ["ieee1609dot2.elevation", "ieee1609dot2.generationLocation_element", 2, 0, 0, 61439, False], # range unverified
    ...
    ["ieee1609dot2.crlSeries","ieee1609dot2.toBeSigned_element", 2, 0, 0, 65535, True], # range unverified
    ...
    ["ieee1609dot2.iCert", "ieee1609dot2.linkageData_element", 2, 0, 0, 65535, False],  # range unverified
    ["ieee1609dot2.linkage", "ieee1609dot2.linkageData_element", 9, 1, 9, 00, False],    
    ...
    ["ieee1609dot2.hours", "ieee1609dot2.duration", 2, 0, 0, 65535, False], # range unverified
    ["ieee1609dot2.minutes", "ieee1609dot2.duration", 2, 0, 0, 65535, False], # range unverified
    ["ieee1609dot2.years", "ieee1609dot2.duration", 2, 0, 0, 65535, False], #  range unverified
        # region 
    ["ieee1609dot2.countryOnly", "ieee1609dot2.IdentifiedRegion", 2, 0, 0, 65535, False],  # range unverified
