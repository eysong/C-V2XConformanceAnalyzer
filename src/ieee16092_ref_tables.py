...
ieee16092_spdu_ref = [  
    # col[0]=field, col[1]=parent, col[2]=length, col[3]=eval method, col[4]=val1, col[5]=val2, col[6]=mandatory
    #[0]                                  [1]                                           [2] [3][4]          [5]        [6]
    ...
    ["ieee1609dot2.elevation",            "ieee1609dot2.generationLocation_element",     2,  0, -4096,       61439,      False],
    ...
    ["ieee1609dot2.microseconds",         "ieee1609dot2.duration",                       2,  0, 0,           65535,      False],  
    ["ieee1609dot2.milliseconds",         "ieee1609dot2.duration",                       2,  0, 0,           65535,      False], 
    ["ieee1609dot2.seconds",              "ieee1609dot2.duration",                       2,  0, 0,           65535,      False],  
    ["ieee1609dot2.minutes",              "ieee1609dot2.duration",                       2,  0, 0,           65535,      False], 
    ["ieee1609dot2.hours",                "ieee1609dot2.duration",                       2,  0, 0,           65535,      False],
    ["ieee1609dot2.sixtyHours",           "ieee1609dot2.duration",                       2,  0, 0,           65535,      False],  
